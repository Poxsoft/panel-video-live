...
Route::post('getChallenge', [ChallengeController::class, 'getChallenge']);
Route::post('storeChallenge', [ChallengeController::class, 'storeChallenge']);
Route::post('deleteChallenge', [ChallengeController::class, 'deleteChallenge']);
Route::post('updateChallenge', [ChallengeController::class, 'updateChallenge']);